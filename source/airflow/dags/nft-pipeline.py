...
def _processing_nft(ti):
  ...
  processed_nft.to_csv('/Users/yoon/airflow/tmp/processed_nft.csv', index=None, header=False)
...
with DAG(dag_id='nft-pipeline',
  ...
  store_nft = BashOperator(
    task_id='store_nft',
    bash_command='echo -e ".separator ","\n.import /Users/yoon/airflow/tmp/processed_nft.csv nfts" | sqlite3 /Users/yoon/airflow/airflow.db'
  )
